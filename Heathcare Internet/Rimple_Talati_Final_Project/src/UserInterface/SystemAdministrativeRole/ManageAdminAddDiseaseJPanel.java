 ...
 * @author Rimple
 */
public class ManageAdminAddDiseaseJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageAdminAddDiseaseJPanel
     */
    private JPanel userProcessContainer;
    private ManageDiseaseAdmin manageDiseaseAdmin;

    public ManageAdminAddDiseaseJPanel(JPanel userProcessContainer, ManageDiseaseAdmin manageDiseaseAdmin) {
        initComponents();
    ...
    private void populateTable() {
        ...
        model.setRowCount(0);
        for (UserAccount ua : manageDiseaseAdmin.getUserAccountDirectory().getUserAccountList()) {
            //check instance of admin world fda role
            if (ua.getRole() instanceof ManageDiseaseRole) {
    ...
    private void initComponents() {
        ...
        headingJLabel.setText("Manage Admin to add Diseases");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (firstN.matches() && lastN.matches()) {
            ...
            if (IsUserNameUnique) {
                if (manageDiseaseAdmin.getPersonDirectory().getPersonList().size() > 0) {
                    JOptionPane.showMessageDialog(null, "There can be only one admin");
                    return;
                }
                Person person = manageDiseaseAdmin.getPersonDirectory().createPerson(firstName, lastName);

                UserAccount userAccount = manageDiseaseAdmin.getUserAccountDirectory().createUserAccount(username, password, person, new ManageDiseaseRole());
            } else {
